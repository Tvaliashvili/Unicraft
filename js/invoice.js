window.downloadInvoicePDF = function() {
  ...
  const rows = cart.map(i => `
    <tr>
      <td>${i.name}</td>
      <td style="text-align:center">${i.qty} ${i.unit||'ც'}</td>
  ...
  const html = '<!DOCTYPE html><html lang="ka">'
    ...
    + 'გთხოვთ თანხის გადმორიცხვისას დანიშნულებაში მიუთითოთ ინვოისის ნომერი, ხოლო გადახდის ქვითარი გადმოგვიგზავნოთ ელექტრონულ ფოსტაზე: <strong>LLCunicraft@gmail.com</strong></div>'
