window.downloadAdminInvoicePDF = function(rows, invoiceNo, dateStr, buyerName, buyerId) {
  ...
  const html = '<!DOCTYPE html><html lang="ka">'
    ...
    + '<title>ინვოისი ' + invoiceNo + ' - Unicraft</title>'
    ...
    + '<div class="paynote">თანხის გადმორიცხვისას დანიშნულებაში მიუთითეთ ინვოისის ნომერი, ხოლო გადახდის ქვითარი გადმოგვიგზავნოთ ელექტრონულ ფოსტაზე: <strong>LLCunicraft@gmail.com</strong> ან მოგვწერეთ ონლაინ ჩატში საიტზე.</div>'
