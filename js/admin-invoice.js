window.downloadAdminInvoicePDF = function(rows, invoiceNo, dateStr, buyerName, buyerId) {
  ...
  const html = '<!DOCTYPE html><html lang="ka">'
    ...
    + '<div class="paynote">გთხოვთ თანხის გადმორიცხვისად დანიშნულებაში მიუთითოთ ინვოისის ნომერი, ხოლო გადახდის ქვითარი გადმოგვიგზავნოთ ელექტრონულ ფოსტაზე: <strong>LLCunicraft@gmail.com</strong> ან მოგვწერეთ ონლაინ ჩატში საიტზე.</div>'
