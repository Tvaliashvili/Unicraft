window.downloadAdminInvoicePDF = function(rows, invoiceNo, dateStr, buyerName, buyerId, buyerPhone) {
  ...
  const html = '<!DOCTYPE html><html lang="ka">'
    ...
    + '    <div class="plabel">საიდენტიფიკაციო კოდი / პირადი ნომერი</div><div class="pval-mono">' + (buyerId || '–') + '</div>'
    ...
    + '<div class="paynote">თანხის გადმორიცხვისას დანიშნულებაში მიუთითეთ ინვოისის ნომერი, ხოლო გადახდის ქვითარი გადმოგვიგზავნეთ ელექტრონულ ფოსტაზე: <strong>LLCunicraft@gmail.com</strong> ან მოგვწერეთ ონლაინ ჩატში საიტზე.</div>'

    + '<div class="disclaimer"><strong>შენიშვნა:</strong> აღნიშნული ინვოისი ძალაშია მისი შექმნის თარიღის დღეს და შეიძლება შეიცვალოს რამდენიმე დღის შემდეგ. შპს უნიკრაფტი იტოვებს უფლებას ნებისმიერ დროს შეცვალოს ფასები ცალმხრივად და შეტყობინების გარეშე. წინამდებარე ინვოისი არ წარმოადგენს ფასის ფიქსაციის ვალდებულებას.</div>'
